...
import com.mult.dataservice.ttr.dao.ITtrDAO;
import com.mult.dataservice.ttr.model.Ttr;
import com.mult.dataservice.ttr.model.TtrBase;
import com.mult.dataservice.ttr.model.TtrInfo;
import com.mult.dataservice.ttr.model.TtrLegal;
import com.mult.dataservice.ttr.model.TtrNatural;
...
public class TtrServiceImpl implements ITtrService {
	...
	public TtrBase findById(Long id) throws Exception {
		return ttrDao.findById(id);
	}

	@Override
	public List<TtrBase> findAll() throws Exception {
		return ttrDao.findAll();
	}
	...
	private TtrInfo getTtrInfo(JSONObject account, TtrNatural natural, TtrLegal legal) {
		...
		if(account.getString("account_no")!=null)
